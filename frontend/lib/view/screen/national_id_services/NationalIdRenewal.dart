...
class NationalIdRenewal extends StatefulWidget {
  const NationalIdRenewal({super.key});

  @override
  State<NationalIdRenewal> createState() => _NationalIdRenewal();
}

class _NationalIdRenewal extends State<NationalIdRenewal> {
  ...
  List<String> get _reasons => [
    S.of(context).card_expired,
    S.of(context).update_personal_photo,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          S.of(context).national_id_renewal,
            ...
            if (_isVerified)
              _buildSectionCard(
                child: Column(
                  ...
                  children: [
                    _buildSectionHeader(
                      title: S.of(context).renewal_reason,
                      subtitle: S.of(context).select_renewal_reason,
            ...
            if (_isVerified)
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(
                    S.of(context).submit_renewal_request,
